...
export class AuthService {
  ...
  getAll(): Food[] {
    return [
      ...
      {
        id: 3,
        name: 'Enjoy high-speed, seamless network',
        price: 5,
        cookTime: '10-15',
        favorite: false,
        origins: ['germany', 'us'],
      ...
      {
        id: 4,
        name: 'Home Networking & Smart Security',
        price: 2000,
        cookTime: '15-20',
        favorite: true,
      ...
      {
        id: 5,
        name: 'High speed internet & Free Voice',
        price: 1111,
        cookTime: '40-50',
        favorite: false,
        origins: ['india', 'asia'],
        stars: 3.0,
        imageUrl: 'https://jep-asset.akamaized.net/cms/assets/jiofiber/apps/jiophotos/JioPhotosLandingPageThumbnail.png',
        tags: ['SlowFood', 'Soup'],
      },
      {
        id: 6,
        ...
        origins: ['italy'],
        stars: 4.0,
        imageUrl: 'https://jep-asset.akamaized.net/cms/assets/jiofiber/apps/jiogames/Gaming-fiber-list.png',
        tags: ['FastFood', 'Pizza', 'Lunch'],
      },
    ];
  }
